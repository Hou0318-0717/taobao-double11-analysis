...
<%
ArrayList<String[]> list = connDb.index_8();
%>
...
<li class="current"><a href="#">品牌销量排行</a></li><li><a href="./index9.jsp">商家销量排行</a></li>
<li><a href="./index10.jsp">省份行为分布</a></li>
<li><a href="./index11.jsp">年龄段行为偏好</a></li>
</ul></div>
<div class="container"><div class="title">品牌销量排行</div>
<div class="show"><div class="chart-type">柱状图 — 销量前十品牌</div>
<div id="main"></div></div></div></div>
<script>
var x=[],y=[];
<% for(String[] a:list){ %>x.push('品牌<%=a[0]%>');y.push(<%=a[1]%>);<% } %>
var myChart = echarts.init(document.getElementById('main'));
option = {
    title:{text:'品牌销量排行TOP10',left:'center',textStyle:{fontSize:16}},
    tooltip:{trigger:'axis',axisPointer:{type:'shadow'}},
    xAxis:{type:'category',data:x,axisLabel:{rotate:20}},
    yAxis:{type:'value',name:'销量'},
    series:[{type:'bar',data:y,itemStyle:{color:new echarts.graphic.LinearGradient(0,0,0,1,[{offset:0,color:'#f7971e'},{offset:1,color:'#ffd200'}])}}]
};
